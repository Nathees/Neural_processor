...
//scfifo ADD_RAM_OUTPUT_REGISTER="OFF" DEVICE_FAMILY="Cyclone V" LPM_NUMWORDS=256 LPM_SHOWAHEAD="OFF" LPM_WIDTH=64 LPM_WIDTHU=8 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" USE_EAB="ON" aclr clock data empty q rdreq usedw wrreq INTENDED_DEVICE_FAMILY="Cyclone V"
...
//a_dpfifo ADD_RAM_OUTPUT_REGISTER="OFF" ALLOW_RWCYCLE_WHEN_FULL="OFF" DEVICE_FAMILY="Cyclone V" LPM_NUMWORDS=256 LPM_SHOWAHEAD="OFF" lpm_width=64 lpm_widthu=8 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" aclr clock data empty q rreq sclr usedw wreq INTENDED_DEVICE_FAMILY="Cyclone V"
//VERSION_BEGIN 17.1 cbx_altdpram 2017:10:19:05:46:40:SJ cbx_altera_counter 2017:10:19:05:46:40:SJ cbx_altera_syncram 2017:10:19:05:46:40:SJ cbx_altera_syncram_nd_impl 2017:10:19:05:46:40:SJ cbx_altsyncram 2017:10:19:05:46:40:SJ cbx_cycloneii 2017:10:19:05:46:40:SJ cbx_fifo_common 2017:10:19:05:46:40:SJ cbx_lpm_add_sub 2017:10:19:05:46:40:SJ cbx_lpm_compare 2017:10:19:05:46:40:SJ cbx_lpm_counter 2017:10:19:05:46:40:SJ cbx_lpm_decode 2017:10:19:05:46:40:SJ cbx_lpm_mux 2017:10:19:05:46:40:SJ cbx_mgl 2017:10:19:06:38:12:SJ cbx_nadder 2017:10:19:05:46:40:SJ cbx_scfifo 2017:10:19:05:46:40:SJ cbx_stratix 2017:10:19:05:46:40:SJ cbx_stratixii 2017:10:19:05:46:40:SJ cbx_stratixiii 2017:10:19:05:46:40:SJ cbx_stratixv 2017:10:19:05:46:40:SJ cbx_util_mgl 2017:10:19:05:46:40:SJ  VERSION_END
...
module  squeeze_kernal_fifo_cntr
	( 
	aclr,
	clock,
	cnt_en,
...
endmodule //squeeze_kernal_fifo_cntr

//synthesis_resources = lut 8 reg 10 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  squeeze_kernal_fifo_a_fefifo
	( 
	aclr,
	clock,
	empty,
...
`endif
	...
	squeeze_kernal_fifo_cntr   count_usedw
	( 
	.aclr(aclr),
	.clock(clock),
...
endmodule //squeeze_kernal_fifo_a_fefifo
...
module  squeeze_kernal_fifo_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
endmodule //squeeze_kernal_fifo_altsyncram
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  squeeze_kernal_fifo_cntr1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //squeeze_kernal_fifo_cntr1

//synthesis_resources = lut 24 M10K 2 reg 26 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  squeeze_kernal_fifo_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	squeeze_kernal_fifo_a_fefifo   fifo_state
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.wreq(wreq));
	squeeze_kernal_fifo_altsyncram   FIFOram
	( 
	...
	.wren_a(valid_wreq));
	squeeze_kernal_fifo_cntr1   rd_ptr_count
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_rreq),
	...
	.sclr(sclr));
	squeeze_kernal_fifo_cntr1   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
...
endmodule //squeeze_kernal_fifo_a_dpfifo

//synthesis_resources = lut 24 M10K 2 reg 26 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  squeeze_kernal_fifo_scfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	squeeze_kernal_fifo_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
	...
	assign
		...
		sclr = 1'b0,
		usedw = wire_dpfifo_usedw;
endmodule //squeeze_kernal_fifo_scfifo
//VALID FILE
...
module squeeze_kernal_fifo (
	...
	squeeze_kernal_fifo_scfifo	squeeze_kernal_fifo_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
