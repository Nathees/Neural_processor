...
//scfifo ADD_RAM_OUTPUT_REGISTER="OFF" DEVICE_FAMILY="Cyclone V" LPM_NUMWORDS=256 LPM_SHOWAHEAD="OFF" LPM_WIDTH=48 LPM_WIDTHU=8 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" USE_EAB="ON" aclr clock data empty q rdreq usedw wrreq INTENDED_DEVICE_FAMILY="Cyclone V"
...
//a_dpfifo ADD_RAM_OUTPUT_REGISTER="OFF" ALLOW_RWCYCLE_WHEN_FULL="OFF" DEVICE_FAMILY="Cyclone V" LPM_NUMWORDS=256 LPM_SHOWAHEAD="OFF" lpm_width=48 lpm_widthu=8 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" aclr clock data empty q rreq sclr usedw wreq INTENDED_DEVICE_FAMILY="Cyclone V"
//VERSION_BEGIN 17.1 cbx_altdpram 2017:10:19:05:46:40:SJ cbx_altera_counter 2017:10:19:05:46:40:SJ cbx_altera_syncram 2017:10:19:05:46:40:SJ cbx_altera_syncram_nd_impl 2017:10:19:05:46:40:SJ cbx_altsyncram 2017:10:19:05:46:40:SJ cbx_cycloneii 2017:10:19:05:46:40:SJ cbx_fifo_common 2017:10:19:05:46:40:SJ cbx_lpm_add_sub 2017:10:19:05:46:40:SJ cbx_lpm_compare 2017:10:19:05:46:40:SJ cbx_lpm_counter 2017:10:19:05:46:40:SJ cbx_lpm_decode 2017:10:19:05:46:40:SJ cbx_lpm_mux 2017:10:19:05:46:40:SJ cbx_mgl 2017:10:19:06:38:12:SJ cbx_nadder 2017:10:19:05:46:40:SJ cbx_scfifo 2017:10:19:05:46:40:SJ cbx_stratix 2017:10:19:05:46:40:SJ cbx_stratixii 2017:10:19:05:46:40:SJ cbx_stratixiii 2017:10:19:05:46:40:SJ cbx_stratixv 2017:10:19:05:46:40:SJ cbx_util_mgl 2017:10:19:05:46:40:SJ  VERSION_END
...
endmodule //expand_conv_fifo_cntr

//synthesis_resources = lut 8 reg 10 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  expand_conv_fifo_a_fefifo
	( 
	aclr,
	clock,
	empty,
...
`endif
	...
	expand_conv_fifo_cntr   count_usedw
	( 
	.aclr(aclr),
	.clock(clock),
...
endmodule //expand_conv_fifo_a_fefifo


//altsyncram ADDRESS_ACLR_A="NONE" ADDRESS_ACLR_B="NONE" ADDRESS_REG_B="CLOCK1" DEVICE_FAMILY="Cyclone V" ENABLE_ECC="FALSE" INDATA_ACLR_A="NONE" NUMWORDS_A=256 NUMWORDS_B=256 OPERATION_MODE="DUAL_PORT" OUTDATA_ACLR_B="NONE" OUTDATA_REG_B="UNREGISTERED" RDCONTROL_ACLR_B="NONE" RDCONTROL_REG_B="CLOCK0" READ_DURING_WRITE_MODE_MIXED_PORTS="DONT_CARE" WIDTH_A=48 WIDTH_B=48 WIDTH_ECCSTATUS=2 WIDTHAD_A=8 WIDTHAD_B=8 WRCONTROL_ACLR_A="NONE" address_a address_b clock0 clock1 clocken1 data_a q_b wren_a
...
module  expand_conv_fifo_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
endmodule //expand_conv_fifo_altsyncram
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //expand_conv_fifo_cntr1

//synthesis_resources = lut 24 M10K 2 reg 26 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  expand_conv_fifo_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	expand_conv_fifo_a_fefifo   fifo_state
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.wreq(wreq));
	expand_conv_fifo_altsyncram   FIFOram
	( 
	...
	.wren_a(valid_wreq));
	expand_conv_fifo_cntr1   rd_ptr_count
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_rreq),
...
endmodule //expand_conv_fifo_a_dpfifo

//synthesis_resources = lut 24 M10K 2 reg 26 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  expand_conv_fifo_scfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	expand_conv_fifo_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
	...
	assign
		...
		sclr = 1'b0,
		usedw = wire_dpfifo_usedw;
endmodule //expand_conv_fifo_scfifo
//VALID FILE
...
module expand_conv_fifo (
	...
	expand_conv_fifo_scfifo	expand_conv_fifo_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
