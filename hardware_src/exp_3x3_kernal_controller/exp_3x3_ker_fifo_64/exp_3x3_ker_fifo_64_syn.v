...
module  exp_3x3_ker_fifo_64_cntr
	( 
	aclr,
	clock,
	cnt_en,
...
endmodule //exp_3x3_ker_fifo_64_cntr

//synthesis_resources = lut 8 reg 10 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  exp_3x3_ker_fifo_64_a_fefifo
	( 
	aclr,
	clock,
	empty,
...
`endif
	...
	exp_3x3_ker_fifo_64_cntr   count_usedw
	( 
	.aclr(aclr),
	.clock(clock),
...
endmodule //exp_3x3_ker_fifo_64_a_fefifo
...
module  exp_3x3_ker_fifo_64_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
endmodule //exp_3x3_ker_fifo_64_altsyncram
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  exp_3x3_ker_fifo_64_cntr1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //exp_3x3_ker_fifo_64_cntr1

//synthesis_resources = lut 24 M10K 2 reg 26 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  exp_3x3_ker_fifo_64_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	exp_3x3_ker_fifo_64_a_fefifo   fifo_state
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.wreq(wreq));
	exp_3x3_ker_fifo_64_altsyncram   FIFOram
	( 
	...
	.wren_a(valid_wreq));
	exp_3x3_ker_fifo_64_cntr1   rd_ptr_count
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_rreq),
	...
	.sclr(sclr));
	exp_3x3_ker_fifo_64_cntr1   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
...
endmodule //exp_3x3_ker_fifo_64_a_dpfifo

//synthesis_resources = lut 24 M10K 2 reg 26 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  exp_3x3_ker_fifo_64_scfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	exp_3x3_ker_fifo_64_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
	...
	assign
		...
		sclr = 1'b0,
		usedw = wire_dpfifo_usedw;
endmodule //exp_3x3_ker_fifo_64_scfifo
//VALID FILE
...
module exp_3x3_ker_fifo_64 (
	...
	exp_3x3_ker_fifo_64_scfifo	exp_3x3_ker_fifo_64_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
