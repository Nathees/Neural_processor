...
//dcfifo_mixed_widths DEVICE_FAMILY="Cyclone V" LPM_NUMWORDS=128 LPM_SHOWAHEAD="OFF" LPM_WIDTH=64 LPM_WIDTH_R=8 LPM_WIDTHU=7 LPM_WIDTHU_R=10 OVERFLOW_CHECKING="ON" RDSYNC_DELAYPIPE=3 READ_ACLR_SYNCH="ON" UNDERFLOW_CHECKING="ON" USE_EAB="ON" WRITE_ACLR_SYNCH="ON" WRSYNC_DELAYPIPE=3 aclr data q rdclk rdempty rdreq wrclk wrreq wrusedw INTENDED_DEVICE_FAMILY="Cyclone V" ALTERA_INTERNAL_OPTIONS=AUTO_SHIFT_REGISTER_RECOGNITION=OFF
...
//a_gray2bin device_family="Cyclone V" WIDTH=8 bin gray
...
module  squ_bash_fifo_a_gray2bin
	( 
	bin,
	...
	assign
		...
		xor5 = (gray[5] ^ xor6),
		xor6 = (gray[7] ^ gray[6]);
endmodule //squ_bash_fifo_a_gray2bin


//a_graycounter DEVICE_FAMILY="Cyclone V" PVALUE=0 WIDTH=8 aclr clock cnt_en q
...
module  squ_bash_fifo_a_graycounter
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sub_parity4a[1:1] <= 1'b0;
			...
			else  sub_parity4a[1:1] <= ((cnt_en & (counter5a[6] ^ counter5a[7])) | ((~ cnt_en) & sub_parity4a[1:1]));
	assign
		...
		sclr = 1'b0,
		updown = 1'b1;
endmodule //squ_bash_fifo_a_graycounter


//a_graycounter DEVICE_FAMILY="Cyclone V" PVALUE=1 WIDTH=8 aclr clock cnt_en q ALTERA_INTERNAL_OPTIONS=suppress_da_rule_internal=S102
//VERSION_BEGIN 17.1 cbx_a_gray2bin 2017:10:19:05:46:40:SJ cbx_a_graycounter 2017:10:19:05:46:40:SJ cbx_cycloneii 2017:10:19:05:46:40:SJ cbx_mgl 2017:10:19:06:38:12:SJ cbx_stratix 2017:10:19:05:46:40:SJ cbx_stratixii 2017:10:19:05:46:40:SJ  VERSION_END
...
module  squ_bash_fifo_a_graycounter1
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) counter6a[7:7] <= 1'b0;
			...
			else  counter6a[7:7] <= (counter6a[7:7] ^ cntr_cout[6]);
	// synopsys translate_off
	initial
		parity7 = {1{1'b1}};
	// synopsys translate_on
	...
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sub_parity8a[1:1] <= 1'b0;
			...
			else  sub_parity8a[1:1] <= ((cnt_en & (counter6a[6] ^ counter6a[7])) | ((~ cnt_en) & sub_parity8a[1:1]));
	assign
		cntr_cout = {1'b0, (cntr_cout[5] & (~ counter6a[5:5])), (cntr_cout[4] & (~ counter6a[4:4])), (cntr_cout[3] & (~ counter6a[3:3])), (cntr_cout[2] & (~ counter6a[2:2])), (cntr_cout[1] & (~ counter6a[1:1])), (cntr_cout[0] & (~ counter6a[0:0])), (cnt_en & parity_cout)},
		parity_cout = (((~ parity7) ^ updown) & cnt_en),
		q = counter6a,
		sclr = 1'b0,
		updown = 1'b1;
endmodule //squ_bash_fifo_a_graycounter1


//altsyncram ADDRESS_ACLR_B="CLEAR1" ADDRESS_REG_B="CLOCK1" CLOCK_ENABLE_INPUT_B="BYPASS" DEVICE_FAMILY="Cyclone V" OPERATION_MODE="DUAL_PORT" OUTDATA_ACLR_B="CLEAR1" OUTDATA_REG_B="CLOCK1" WIDTH_A=64 WIDTH_B=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=7 WIDTHAD_B=10 aclr1 address_a address_b addressstall_b clock0 clock1 clocken1 data_a q_b wren_a
...
module  squ_bash_fifo_altsyncram
	( 
	aclr1,
	address_a,
	address_b,
...
`endif
	...
	defparam
		...
		ram_block9a_0.port_a_address_width = 7,
		ram_block9a_0.port_a_data_width = 8,
		ram_block9a_0.port_a_first_address = 0,
		ram_block9a_0.port_a_first_bit_number = 0,
		ram_block9a_0.port_a_last_address = 127,
		ram_block9a_0.port_a_logical_ram_depth = 128,
		...
		ram_block9a_0.port_b_address_width = 10,
		...
		ram_block9a_0.port_b_last_address = 1023,
		ram_block9a_0.port_b_logical_ram_depth = 1024,
	...
	defparam
		...
		ram_block9a_1.port_a_address_width = 7,
		ram_block9a_1.port_a_data_width = 8,
		ram_block9a_1.port_a_first_address = 0,
		ram_block9a_1.port_a_first_bit_number = 1,
		ram_block9a_1.port_a_last_address = 127,
		ram_block9a_1.port_a_logical_ram_depth = 128,
		...
		ram_block9a_1.port_b_address_width = 10,
		...
		ram_block9a_1.port_b_last_address = 1023,
		ram_block9a_1.port_b_logical_ram_depth = 1024,
	...
	defparam
		...
		ram_block9a_2.port_a_address_width = 7,
		ram_block9a_2.port_a_data_width = 8,
		ram_block9a_2.port_a_first_address = 0,
		ram_block9a_2.port_a_first_bit_number = 2,
		ram_block9a_2.port_a_last_address = 127,
		ram_block9a_2.port_a_logical_ram_depth = 128,
		...
		ram_block9a_2.port_b_address_width = 10,
		...
		ram_block9a_2.port_b_last_address = 1023,
		ram_block9a_2.port_b_logical_ram_depth = 1024,
	...
	defparam
		...
		ram_block9a_3.port_a_address_width = 7,
		ram_block9a_3.port_a_data_width = 8,
		ram_block9a_3.port_a_first_address = 0,
		ram_block9a_3.port_a_first_bit_number = 3,
		ram_block9a_3.port_a_last_address = 127,
		ram_block9a_3.port_a_logical_ram_depth = 128,
		...
		ram_block9a_3.port_b_address_width = 10,
		...
		ram_block9a_3.port_b_last_address = 1023,
		ram_block9a_3.port_b_logical_ram_depth = 1024,
	...
	defparam
		...
		ram_block9a_4.port_a_address_width = 7,
		ram_block9a_4.port_a_data_width = 8,
		ram_block9a_4.port_a_first_address = 0,
		ram_block9a_4.port_a_first_bit_number = 4,
		ram_block9a_4.port_a_last_address = 127,
		ram_block9a_4.port_a_logical_ram_depth = 128,
		...
		ram_block9a_4.port_b_address_width = 10,
		...
		ram_block9a_4.port_b_last_address = 1023,
		ram_block9a_4.port_b_logical_ram_depth = 1024,
	...
	defparam
		...
		ram_block9a_5.port_a_address_width = 7,
		ram_block9a_5.port_a_data_width = 8,
		ram_block9a_5.port_a_first_address = 0,
		ram_block9a_5.port_a_first_bit_number = 5,
		ram_block9a_5.port_a_last_address = 127,
		ram_block9a_5.port_a_logical_ram_depth = 128,
		...
		ram_block9a_5.port_b_address_width = 10,
		...
		ram_block9a_5.port_b_last_address = 1023,
		ram_block9a_5.port_b_logical_ram_depth = 1024,
	...
	defparam
		...
		ram_block9a_6.port_a_address_width = 7,
		ram_block9a_6.port_a_data_width = 8,
		ram_block9a_6.port_a_first_address = 0,
		ram_block9a_6.port_a_first_bit_number = 6,
		ram_block9a_6.port_a_last_address = 127,
		ram_block9a_6.port_a_logical_ram_depth = 128,
		...
		ram_block9a_6.port_b_address_width = 10,
		...
		ram_block9a_6.port_b_last_address = 1023,
		ram_block9a_6.port_b_logical_ram_depth = 1024,
	...
	defparam
		...
		ram_block9a_7.port_a_address_width = 7,
		ram_block9a_7.port_a_data_width = 8,
		ram_block9a_7.port_a_first_address = 0,
		ram_block9a_7.port_a_first_bit_number = 7,
		ram_block9a_7.port_a_last_address = 127,
		ram_block9a_7.port_a_logical_ram_depth = 128,
		...
		ram_block9a_7.port_b_address_width = 10,
		...
		ram_block9a_7.port_b_last_address = 1023,
		ram_block9a_7.port_b_logical_ram_depth = 1024,
...
endmodule //squ_bash_fifo_altsyncram
...
`endif
	...
	assign
		...
		q = dffe11a,
		sclr = 1'b0;
endmodule //squ_bash_fifo_dffpipe


//dffpipe DELAY=1 WIDTH=8 clock clrn d ALTERA_INTERNAL_OPTIONS=X_ON_VIOLATION_OPTION=OFF
//VERSION_BEGIN 17.1 cbx_a_gray2bin 2017:10:19:05:46:40:SJ cbx_a_graycounter 2017:10:19:05:46:40:SJ cbx_altdpram 2017:10:19:05:46:40:SJ cbx_altera_counter 2017:10:19:05:46:40:SJ cbx_altera_gray_counter 2017:10:19:05:46:40:SJ cbx_altera_syncram 2017:10:19:05:46:40:SJ cbx_altera_syncram_nd_impl 2017:10:19:05:46:40:SJ cbx_altsyncram 2017:10:19:05:46:40:SJ cbx_cycloneii 2017:10:19:05:46:40:SJ cbx_dcfifo 2017:10:19:05:46:40:SJ cbx_fifo_common 2017:10:19:05:46:40:SJ cbx_lpm_add_sub 2017:10:19:05:46:40:SJ cbx_lpm_compare 2017:10:19:05:46:40:SJ cbx_lpm_counter 2017:10:19:05:46:40:SJ cbx_lpm_decode 2017:10:19:05:46:40:SJ cbx_lpm_mux 2017:10:19:05:46:40:SJ cbx_mgl 2017:10:19:06:38:12:SJ cbx_nadder 2017:10:19:05:46:40:SJ cbx_scfifo 2017:10:19:05:46:40:SJ cbx_stratix 2017:10:19:05:46:40:SJ cbx_stratixii 2017:10:19:05:46:40:SJ cbx_stratixiii 2017:10:19:05:46:40:SJ cbx_stratixv 2017:10:19:05:46:40:SJ cbx_util_mgl 2017:10:19:05:46:40:SJ  VERSION_END
...
`endif
	...
	assign
		...
		q = dffe13a,
		sclr = 1'b0;
endmodule //squ_bash_fifo_dffpipe1
...
module  squ_bash_fifo_alt_synch_pipe
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	squ_bash_fifo_dffpipe1   dffpipe12
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe12_q;
endmodule //squ_bash_fifo_alt_synch_pipe


//dffpipe DELAY=1 WIDTH=8 clock clrn d q ALTERA_INTERNAL_OPTIONS=X_ON_VIOLATION_OPTION=OFF
//VERSION_BEGIN 17.1 cbx_a_gray2bin 2017:10:19:05:46:40:SJ cbx_a_graycounter 2017:10:19:05:46:40:SJ cbx_altdpram 2017:10:19:05:46:40:SJ cbx_altera_counter 2017:10:19:05:46:40:SJ cbx_altera_gray_counter 2017:10:19:05:46:40:SJ cbx_altera_syncram 2017:10:19:05:46:40:SJ cbx_altera_syncram_nd_impl 2017:10:19:05:46:40:SJ cbx_altsyncram 2017:10:19:05:46:40:SJ cbx_cycloneii 2017:10:19:05:46:40:SJ cbx_dcfifo 2017:10:19:05:46:40:SJ cbx_fifo_common 2017:10:19:05:46:40:SJ cbx_lpm_add_sub 2017:10:19:05:46:40:SJ cbx_lpm_compare 2017:10:19:05:46:40:SJ cbx_lpm_counter 2017:10:19:05:46:40:SJ cbx_lpm_decode 2017:10:19:05:46:40:SJ cbx_lpm_mux 2017:10:19:05:46:40:SJ cbx_mgl 2017:10:19:06:38:12:SJ cbx_nadder 2017:10:19:05:46:40:SJ cbx_scfifo 2017:10:19:05:46:40:SJ cbx_stratix 2017:10:19:05:46:40:SJ cbx_stratixii 2017:10:19:05:46:40:SJ cbx_stratixiii 2017:10:19:05:46:40:SJ cbx_stratixv 2017:10:19:05:46:40:SJ cbx_util_mgl 2017:10:19:05:46:40:SJ  VERSION_END
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF"} *)
module  squ_bash_fifo_dffpipe12
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		if (prn == 1'b0) dffe15a <= {8{1'b1}};
		else if (clrn == 1'b0) dffe15a <= 8'b0;
		else if  (ena == 1'b1)   dffe15a <= (d & {8{(~ sclr)}});
	assign
		ena = 1'b1,
		prn = 1'b1,
		q = dffe15a,
		sclr = 1'b0;
endmodule //squ_bash_fifo_dffpipe12
...
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"X_ON_VIOLATION_OPTION=OFF"} *)
module  squ_bash_fifo_alt_synch_pipe1
	( 
	clock,
	clrn,
	d,
...
`endif
	...
	wire  [7:0]   wire_dffpipe14_q;

	squ_bash_fifo_dffpipe12   dffpipe14
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe14_q;
endmodule //squ_bash_fifo_alt_synch_pipe1


//lpm_add_sub DEVICE_FAMILY="Cyclone V" LPM_DIRECTION="SUB" LPM_WIDTH=8 dataa datab result
...
`endif
	...
	assign
		...
		sel_wire = {sel[0]};
endmodule //squ_bash_fifo_mux

//synthesis_resources = lut 16 M10K 2 reg 92 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF;REMOVE_DUPLICATE_REGISTERS=OFF;suppress_da_rule_internal=d101;suppress_da_rule_internal=d102;suppress_da_rule_internal=d103;SYNCHRONIZER_IDENTIFICATION=OFF;SYNCHRONIZATION_REGISTER_CHAIN_LENGTH = 1;suppress_da_rule_internal=R105;-name CUT ON -from rdptr_g -to ws_dgrp|squ_bash_fifo_dffpipe12:dffpipe14|dffe15a;-name SDC_STATEMENT \"set_false_path -from *rdptr_g* -to *ws_dgrp|squ_bash_fifo_dffpipe12:dffpipe14|dffe15a* \""} *)
module  squ_bash_fifo_dcfifo
	( 
	aclr,
	data,
	q,
...
`endif
	...
	wire  [7:0]   wire_wrptr_g_gray2bin_bin;
	wire  [7:0]   wire_ws_dgrp_gray2bin_bin;
	...
	wire  [7:0]   wire_ws_brp_q;
	wire  [7:0]   wire_ws_bwp_q;
	wire  [7:0]   wire_ws_dgrp_q;
	wire	[7:0]	wire_wrusedw_sub_dataa;
	wire	[7:0]	wire_wrusedw_sub_datab;
	wire	[7:0]	wire_wrusedw_sub_result;
	...
	squ_bash_fifo_a_gray2bin   wrptr_g_gray2bin
	( 
	.bin(wire_wrptr_g_gray2bin_bin),
	.gray(wrptr_g));
	squ_bash_fifo_a_gray2bin   ws_dgrp_gray2bin
	( 
	.bin(wire_ws_dgrp_gray2bin_bin),
	.gray(wire_ws_dgrp_q));
	squ_bash_fifo_a_graycounter   rdptr_g1p
	( 
	.aclr((~ wire_rdaclr_q)),
	.clock(rdclk),
	.cnt_en((valid_rdreq & wire_cntr_b_cout)),
	.q(wire_rdptr_g1p_q));
	squ_bash_fifo_a_graycounter1   wrptr_g1p
	( 
	.aclr((~ wire_wraclr_q)),
	.clock(wrclk),
	.cnt_en(valid_wrreq),
	.q(wire_wrptr_g1p_q));
	squ_bash_fifo_altsyncram   fifo_ram
	( 
	.aclr1((~ wire_rdaclr_q)),
	...
	always @ ( posedge wrclk or  negedge wire_wraclr_q)
		if (wire_wraclr_q == 1'b0) delayed_wrptr_g <= 8'b0;
	...
	// synopsys translate_on
	always @ ( posedge rdclk or  negedge wire_rdaclr_q)
		if (wire_rdaclr_q == 1'b0) rdptr_b <= 3'b0;
	...
	// synopsys translate_on
	always @ ( posedge rdclk or  negedge wire_rdaclr_q)
		if (wire_rdaclr_q == 1'b0) rdptr_g <= 8'b0;
	...
	// synopsys translate_on
	always @ ( posedge wrclk or  negedge wire_wraclr_q)
		if (wire_wraclr_q == 1'b0) wrptr_g <= 8'b0;
		else if  (valid_wrreq == 1'b1)   wrptr_g <= wire_wrptr_g1p_q;
	squ_bash_fifo_dffpipe   rdaclr
	( 
	.clock(rdclk),
	.clrn((~ aclr)),
	.d(1'b1),
	.q(wire_rdaclr_q));
	squ_bash_fifo_alt_synch_pipe   rs_dgwp
	( 
	.clock(rdclk),
	.clrn(wire_rdaclr_q),
	.d(delayed_wrptr_g),
	.q(wire_rs_dgwp_q));
	squ_bash_fifo_dffpipe   wraclr
	( 
	.clock(wrclk),
	.clrn((~ aclr)),
	.d(1'b1),
	.q(wire_wraclr_q));
	squ_bash_fifo_dffpipe1   ws_brp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(wire_ws_dgrp_gray2bin_bin),
	.q(wire_ws_brp_q));
	squ_bash_fifo_dffpipe1   ws_bwp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(wire_wrptr_g_gray2bin_bin),
	.q(wire_ws_bwp_q));
	squ_bash_fifo_alt_synch_pipe1   ws_dgrp
	( 
	.clock(wrclk),
	.clrn(wire_wraclr_q),
	.d(rdptr_g),
	...
	assign
		...
		wrusedw = {wire_wrusedw_sub_result[6:0]};
endmodule //squ_bash_fifo_dcfifo
//VALID FILE
...
`endif
	...
	squ_bash_fifo_dcfifo	squ_bash_fifo_dcfifo_component (
				.aclr (aclr),
				.data (data),
				.rdclk (rdclk),
				.rdreq (rdreq),
