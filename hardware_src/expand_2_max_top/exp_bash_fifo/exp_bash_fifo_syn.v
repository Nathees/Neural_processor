...
//scfifo ADD_RAM_OUTPUT_REGISTER="OFF" DEVICE_FAMILY="Cyclone V" LPM_NUMWORDS=128 LPM_SHOWAHEAD="OFF" LPM_WIDTH=64 LPM_WIDTHU=7 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" USE_EAB="ON" aclr clock data empty q rdreq usedw wrreq INTENDED_DEVICE_FAMILY="Cyclone V"
...
//a_dpfifo ADD_RAM_OUTPUT_REGISTER="OFF" ALLOW_RWCYCLE_WHEN_FULL="OFF" DEVICE_FAMILY="Cyclone V" LPM_NUMWORDS=128 LPM_SHOWAHEAD="OFF" lpm_width=64 lpm_widthu=7 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" aclr clock data empty q rreq sclr usedw wreq INTENDED_DEVICE_FAMILY="Cyclone V"
//VERSION_BEGIN 17.1 cbx_altdpram 2017:10:19:05:46:40:SJ cbx_altera_counter 2017:10:19:05:46:40:SJ cbx_altera_syncram 2017:10:19:05:46:40:SJ cbx_altera_syncram_nd_impl 2017:10:19:05:46:40:SJ cbx_altsyncram 2017:10:19:05:46:40:SJ cbx_cycloneii 2017:10:19:05:46:40:SJ cbx_fifo_common 2017:10:19:05:46:40:SJ cbx_lpm_add_sub 2017:10:19:05:46:40:SJ cbx_lpm_compare 2017:10:19:05:46:40:SJ cbx_lpm_counter 2017:10:19:05:46:40:SJ cbx_lpm_decode 2017:10:19:05:46:40:SJ cbx_lpm_mux 2017:10:19:05:46:40:SJ cbx_mgl 2017:10:19:06:38:12:SJ cbx_nadder 2017:10:19:05:46:40:SJ cbx_scfifo 2017:10:19:05:46:40:SJ cbx_stratix 2017:10:19:05:46:40:SJ cbx_stratixii 2017:10:19:05:46:40:SJ cbx_stratixiii 2017:10:19:05:46:40:SJ cbx_stratixv 2017:10:19:05:46:40:SJ cbx_util_mgl 2017:10:19:05:46:40:SJ  VERSION_END


//a_fefifo ALLOW_RWCYCLE_WHEN_FULL="OFF" LPM_NUMWORDS=128 lpm_widthad=7 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" aclr clock empty full rreq sclr usedw_out wreq
...
//lpm_counter DEVICE_FAMILY="Cyclone V" lpm_width=7 aclr clock cnt_en q sclr updown
...
endmodule //exp_bash_fifo_cntr

//synthesis_resources = lut 7 reg 9 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  exp_bash_fifo_a_fefifo
	( 
	aclr,
	clock,
	empty,
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else  b_full <= ((b_full & (b_full ^ (sclr | rreq))) | (((~ b_full) & b_non_empty) & ((~ sclr) & ((is_almost_full6 & wreq) & (~ rreq)))));
	// synopsys translate_off
	initial
		b_non_empty = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else  b_non_empty <= (((b_full & (b_full ^ sclr)) | (((~ b_non_empty) & wreq) & (~ sclr))) | (((~ b_full) & b_non_empty) & (((~ b_full) & b_non_empty) ^ (sclr | ((is_almost_empty6 & rreq) & (~ wreq))))));
	exp_bash_fifo_cntr   count_usedw
	( 
	.aclr(aclr),
	.clock(clock),
...
endmodule //exp_bash_fifo_a_fefifo


//altsyncram ADDRESS_ACLR_A="NONE" ADDRESS_ACLR_B="NONE" ADDRESS_REG_B="CLOCK1" DEVICE_FAMILY="Cyclone V" ENABLE_ECC="FALSE" INDATA_ACLR_A="NONE" NUMWORDS_A=128 NUMWORDS_B=128 OPERATION_MODE="DUAL_PORT" OUTDATA_ACLR_B="NONE" OUTDATA_REG_B="UNREGISTERED" RDCONTROL_ACLR_B="NONE" RDCONTROL_REG_B="CLOCK0" READ_DURING_WRITE_MODE_MIXED_PORTS="DONT_CARE" WIDTH_A=64 WIDTH_B=64 WIDTH_ECCSTATUS=2 WIDTHAD_A=7 WIDTHAD_B=7 WRCONTROL_ACLR_A="NONE" address_a address_b clock0 clock1 clocken1 data_a q_b wren_a
...
module  exp_bash_fifo_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
endmodule //exp_bash_fifo_altsyncram


//lpm_counter DEVICE_FAMILY="Cyclone V" lpm_direction="UP" lpm_port_updown="PORT_UNUSED" lpm_width=7 aclr clock cnt_en q sclr
//VERSION_BEGIN 17.1 cbx_cycloneii 2017:10:19:05:46:40:SJ cbx_lpm_add_sub 2017:10:19:05:46:40:SJ cbx_lpm_compare 2017:10:19:05:46:40:SJ cbx_lpm_counter 2017:10:19:05:46:40:SJ cbx_lpm_decode 2017:10:19:05:46:40:SJ cbx_mgl 2017:10:19:06:38:12:SJ cbx_nadder 2017:10:19:05:46:40:SJ cbx_stratix 2017:10:19:05:46:40:SJ cbx_stratixii 2017:10:19:05:46:40:SJ  VERSION_END
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //exp_bash_fifo_cntr1

//synthesis_resources = lut 21 M10K 2 reg 23 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  exp_bash_fifo_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	wire  [6:0]   wire_fifo_state_usedw_out;
	wire  [63:0]   wire_FIFOram_q_b;
	wire  [6:0]   wire_rd_ptr_count_q;
	wire  [6:0]   wire_wr_ptr_q;
	wire  [6:0]  rd_ptr;
	wire  valid_rreq;
	wire  valid_wreq;

	exp_bash_fifo_a_fefifo   fifo_state
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.wreq(wreq));
	exp_bash_fifo_altsyncram   FIFOram
	( 
	.address_a(wire_wr_ptr_q),
	.address_b(({7{(~ sclr)}} & rd_ptr)),
	.clock0(clock),
	.clock1(clock),
	...
	.wren_a(valid_wreq));
	exp_bash_fifo_cntr1   rd_ptr_count
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_rreq),
...
endmodule //exp_bash_fifo_a_dpfifo

//synthesis_resources = lut 21 M10K 2 reg 23 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  exp_bash_fifo_scfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	wire  [6:0]   wire_dpfifo_usedw;
	wire sclr;

	exp_bash_fifo_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
	...
	assign
		...
		sclr = 1'b0,
		usedw = wire_dpfifo_usedw;
endmodule //exp_bash_fifo_scfifo
//VALID FILE
...
module exp_bash_fifo (
	...
	exp_bash_fifo_scfifo	exp_bash_fifo_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
